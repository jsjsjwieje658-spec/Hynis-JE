 ...
 *
 * GLFW 3.4 IME status callback, backported into the Pojav-style GLFW
 * override so Minecraft 26.1 (LWJGL 3.4 API) finds the class it references
 * during InputConstants.setupKeyboardCallbacks. Follows the exact
 * structure of GLFWCharCallback in this port.
 */
...
public abstract class GLFWIMEStatusCallback extends Callback implements GLFWIMEStatusCallbackI {
    ...
    protected GLFWIMEStatusCallback() {
        super(GLFWIMEStatusCallbackI.CIF);
    }
